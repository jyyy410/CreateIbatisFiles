...
public class CreateDmsCurdFile {
   ...
   //数据库名
	private static String tableName = "DT_TP_SO_CONTRACT_T";
	//vo名
	private static String voName = "DtTpSoContractt";// VO   

	// 数据库连接

	
	private static final String URL = "jdbc:oracle:thin:@127.0.0.1:1521:dms";
